...
package science.freeabyss.algorithm.util.draw;

import science.freeabyss.algorithm.util.io.StdIn;
...
public class Interval2D {
    ...
    public static void main(String[] args) {
        ...
        double xmin = Double.parseDouble(parameter[0]);
        double xmax = Double.parseDouble(parameter[1]);
        double ymin = Double.parseDouble(parameter[2]);
        double ymax = Double.parseDouble(parameter[3]);
        int trials = Integer.parseInt(parameter[4]);
